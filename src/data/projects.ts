...
export const projects: Project[] = [
  ...
  {
    slug: "furniturelux-website",
    name: "FurnitureLux – Luxury Furniture Web Experience",
    description:
      "A premium furniture web platform designed to showcase elegant furniture collections, rooms, and products. Features interactive galleries, scroll animations, hover effects, and a modern UI built with Tailwind CSS and Framer Motion for a high-end browsing experience.",
    thumbnail: "/projects/furniturelux/thumbnail.jpg",
    images: [
      "/projects/furniturelux/hero.jpg",
      "/projects/furniturelux/about.jpg",
    ...
    introduction:
      "FurnitureLux is a modern web application designed for showcasing luxury furniture and home interiors. It provides an immersive browsing experience through dynamic product galleries, interactive room showcases, and engaging testimonials. Built with responsive design, it ensures seamless performance across devices, with a clean, elegant interface highlighting premium products and collections. Perfect for portfolios or luxury furniture brands looking for a high-class web presence.",
    features: [
      "Landing page with hero section and transparent sidebar navigation",
      "About section with animated image and text highlights",
      "Category grid with hover effects and parallax animations",
      "Room showcase with floating product cards and dynamic layouts",
      "Products section in responsive grid layout with hover & parallax effects",
      "Collections highlight with animated cards and overlay information",
      "Testimonials section with opacity variations for depth",
      "Footer with social icons, contact info, and subtle animations",
      "High-quality images for hero, products, rooms, and collections",
      "Responsive design for desktop, tablet, and mobile devices",
      "Framer Motion-powered animations for smooth scroll, hover, and entry effects",
      "Reusable card components for products, rooms, collections, and testimonials",
      "SEO-friendly structure and metadata for web showcase",
      "Glassmorphic overlays and hover interactions for premium feel",
      "Optimized performance and smooth interaction across modern browsers",
      "Minimal, elegant Tailwind CSS design with brown and neutral accents",
      "POV illustration for thumbnail showing the full web interface",
    ],
  },
];
