...
export const projects: Project[] = [
  ...
  {
    slug: "sma-negeri-contoh",
    name: "SMA Negeri Contoh – Sekolah Website",
    description:
      "A modern, responsive school website prototype designed to showcase SMA Negeri Contoh’s profile, news, announcements, extracurricular activities, and academic information through a clean, mobile-first, and human-centered interface.",
    thumbnail: "/projects/sma-negeri-contoh/thumbnail.jpg",
    images: [
      "/projects/sma-negeri-contoh/hero.jpg",
      "/projects/sma-negeri-contoh/beranda-artikel.jpg",
      "/projects/sma-negeri-contoh/pengumuman.jpg",
      "/projects/sma-negeri-contoh/ekstrakurikuler.jpg",
      "/projects/sma-negeri-contoh/galeri.jpg",
      "/projects/sma-negeri-contoh/kontak.jpg",
    ],
    tech: [
      "React",
      "TypeScript",
    ...
    introduction:
      "SMA Negeri Contoh is a modern school website prototype built to present school information in a clear, responsive, and engaging way. The website emphasizes accessibility, intuitive navigation, and visual clarity for students, parents, and staff. Core features include a dynamic homepage with hero, history, articles, announcements, extracurricular sections, profile pages with teacher/staff data, gallery, contact page, and a smooth scroll-activated navbar. The project is mobile-first and demonstrates best practices in component-based React architecture, Tailwind styling, and frontend UX design suitable for portfolio or educational showcase.",
    features: [
      "Homepage hero section with background image, overlay, animated title, and CTA button",
      "History section with text and images",
      "Articles section with grid of latest articles, popular articles, and 'read more' links",
      "Announcements section with latest announcements and link to view all",
      "Extracurricular section with 3-grid preview and link to full list, including detailed description modals",
      "Video profile embed from YouTube",
      "Gallery page with responsive image grid and modal preview",
      "Profile pages: Organizational structure, teacher/staff data with search & pagination, modal details",
      "Dropdown navigation menu with click-to-open submenus and active state highlighting",
      "Global search form navigating to search results page",
      "Contact page with contact form, Google Maps iframe, and school info",
      "Responsive design for mobile, tablet, and desktop",
      "Navbar with transparent background over hero and smooth fade-in background on scroll",
      "Reusable card-based UI components with clear visual hierarchy",
      "Lightweight frontend architecture built with React + Vite + TypeScript + Tailwind CSS v3",
      "Ready for future backend integration or CMS system for dynamic content",
    ],
  },
  {
    slug: "restoran-sederhana",
    name: "Restoran Sederhana – Sistem Pemesanan Online",
    description:
      "A modern, responsive restaurant web app prototype designed to showcase menu, cart, checkout, and POS management for admin, cashier, and customer users, with clean UI, Tailwind styling, and seamless user experience.",
    thumbnail: "/projects/restoran-sederhana/thumbnail.jpg",
    images: [
      "/projects/restoran-sederhana/hero.jpg",
      "/projects/restoran-sederhana/menu-page.jpg",
      "/projects/restoran-sederhana/cart-page.jpg",
      "/projects/restoran-sederhana/checkout-page.jpg",
      "/projects/restoran-sederhana/kasir-dashboard.jpg",
      "/projects/restoran-sederhana/admin-dashboard.jpg",
    ],
    tech: [
      "Laravel 12",
      "PHP 8.3",
    ...
    introduction:
      "Restoran Sederhana is a restaurant web application prototype built to streamline ordering, payment, and POS management. It provides a mobile-first user experience where customers can view menus, add items to the cart, and checkout via Midtrans. Admins can manage categories, menus, transactions, and cashiers, while cashiers can handle walk-in orders and reservations. The project emphasizes clean UI, clear user flows, and a modern responsive design suitable for portfolio showcase or small business deployment.",
    features: [
      "User-facing menu with categories, quantity selector, and notes for each dish",
      "Cart page showing all selected items with subtotal, update, and remove functions",
      "Checkout page integrating Midtrans Snap popup for payment",
      "Automatic cart clearing and payment status update after successful checkout",
      "Admin dashboard with master data: categories, menus, cashiers",
      "Admin view for transactions and reservations",
      "Admin reports on income and sales",
      "Cashier dashboard for managing walk-in orders and reservations",
      "Multi-role login system: admin, cashier, user",
      "Mobile-first, responsive layout for all devices",
      "Reusable card-based UI for menu, cart, and dashboard components",
      "Clean, modern Tailwind CSS styling with fixed header and sidebar",
      "POV illustration of cashier tablet and user smartphone for marketing/thumbnail",
      "Session-based cart storage and server-side transaction handling",
      "Ready for future backend integrations or API expansions",
    ],
  },
  {
    slug: "luxury-property-platform",
    name: "Luxury Property Platform – Premium Real Estate Web",
    description:
      "A high-end real estate web platform prototype designed to showcase luxury properties, with featured listings, search & filter functionality, property detail pages, and smooth animations. Clean UI using Tailwind CSS and Framer Motion for premium user experience.",
    thumbnail: "/projects/luxury-property-platform/thumbnail.jpg",
    images: [
      "/projects/luxury-property-platform/hero.jpg",
      "/projects/luxury-property-platform/property-list.jpg",
      "/projects/luxury-property-platform/property-detail.jpg",
      "/projects/luxury-property-platform/search-filter.jpg",
      "/projects/luxury-property-platform/featured-properties.jpg",
      "/projects/luxury-property-platform/features.jpg",
    ],
    tech: [
      "React 18",
      "TypeScript",
    ...
    introduction:
      "Luxury Property Platform is a modern web application prototype designed for showcasing premium real estate listings. It provides users with an elegant browsing experience, including advanced property search, filtering by location, type, and price, and detailed property pages with gallery and amenities. Built with responsive design in mind, it ensures a seamless experience across all devices and emphasizes sophisticated, high-class UI suitable for portfolio showcase or real estate agencies targeting luxury clients.",
    features: [
      "Homepage with featured luxury properties and subtle animation effects",
      "Property listing page with search and filter by location, type, and price",
      "Individual property detail pages with image gallery, description, and contact CTA",
      "Floating 'Back to Home/Properties' buttons for easy navigation",
      "Framer Motion-powered animations for smooth hover effects and page transitions",
      "Responsive design for desktop, tablet, and mobile views",
      "Reusable card components for properties and featured listings",
      "Glassmorphic filter UI with hover and focus effects",
      "Dynamic filtering that updates results instantly without page reload",
      "SEO-friendly structure and metadata for web showcase",
      "High-resolution images and mockups of luxury properties",
      "Easy to scale and integrate future backend features or APIs",
      "Minimal, clean, and elegant Tailwind CSS design language with dark/light accents",
      "POV illustration of laptop showing the web interface for marketing/thumbnail",
      "Optimized for speed and smooth interaction across modern browsers",
    ],
  },
];
